...
set CommonCompilerFlags2= -fp:except- -fp:fast -nologo -EHsc -Od -wd4702 -wd4505  
...
cl %CommonCompilerFlags% ..\code\test_arena.cpp /link %CommonLinkerFlags%

REM cl %CommonCompilerFlags% ..\code\generate_polygon_file.cpp -Fmmain.map /link %CommonLinkerFlags%

cl %CommonCompilerFlags2% /std:c++17  ..\code\test_clipper2.cpp -Fmtest_clipper2.map /link %CommonLinkerFlags2% 
